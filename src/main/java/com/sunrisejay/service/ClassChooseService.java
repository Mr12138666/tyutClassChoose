...
public class ClassChooseService {
    ...
    public String getCourseList(User user) throws Exception {
        ...
        String content = HttpClientUtils.doPost("Tschedule/C4Xkgl/GetXkPageListJson", NODE, user.getCookieStore(), formParams);

        return content;
    }

    public String getFirstCourseUID(User user, String courseList) throws Exception {
    ...
    public String getCourseDetail(User user, String uid) throws Exception {
        ...
        //todo 此地址存疑！！！！！
        String content = HttpClientUtils.doPost("Tschedule/C4Xkgl/GetXkkcListByXh", NODE, user.getCookieStore(), formParams);
    ...
    public Boolean tryCatchTeacher(User user, String courseDetail, String pid, List<TeacherChooseData> dataObjects) throws Exception {
        ...
        for (TeacherChooseData dataObject : dataObjects) {
            ...
            String content = HttpClientUtils.doPost("Tschedule/C4Xkgl/XsxkSaveForm", NODE, user.getCookieStore(), formParams);
            // 检查响应中是否包含"操作成功"
    ...
    private String checkNameExistence(ArrayList<String> teachers, String name) {
