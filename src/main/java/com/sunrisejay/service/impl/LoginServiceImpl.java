...
public class LoginServiceImpl implements LoginService {
    ...
    public String extractRequestVerificationToken(String indexInfo) {
        // 定义正则表达式
    ...
    public User login(User user) throws Exception {
        ...
        String content = HttpClientUtil.doPost("Login/CheckLogin", NODE, cookieStore, formParams);
        ...
        if (matcher.find()) {
            ...
            if (type.equals("1")) {
                ...
                String getTokenFormContent = HttpClientUtil.doGet("Tschedule/C4Xkgl/XkXsxkIndex?yhm=R3m18OaKO5IALl6PvzDPz6qFtj8pRuCcSydIgHmMN2Ios2c5yfv/d2Aup8pgksJXWQZE/L8wbkZ9vrOSTFdX8jr5Jz4ewiSmYICXNSWViR/vPCgx8bHgcYY+VR4JKT5siATlDPehxIhI25pvgb36g0rba4/3wQQ4nKYUYpVR0+4=&mm=c237053a74zyc431a8a9a6a46748", NODE, cookieStore);
